...
const autoModSanctions = async (guild, member) => {
  ...
  const modLogChannel = await guildsRepository.getGuildSetting(guild, "modLog");
  const embedSettings = await guildsRepository.getGuildSetting(guild, "embedinfo");
...
module.exports.autoModSanctions = autoModSanctions;
